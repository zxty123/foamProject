...
#define reg_spwm_cc            REG_ADDR16(0x80)
enum{
	FLD_SPWM0_EN  = 			BIT(0),
	FLD_SPWM0_MODE  = 			BIT(1),

	FLD_SPWM1_EN  = 			BIT(2),
	FLD_SPWM1_MODE  = 			BIT(3),

	FLD_SPWM2_EN  = 			BIT(4),
	FLD_SPWM2_MODE  = 			BIT_RNG(5,7),

	FLD_SPWM_CLK_DIV  = 		BIT_RNG(8,10),
};


#define reg_spwm_pttn           REG_ADDR16(0x82)

#define SPWM_SETTING           0x84
#define reg_spwm_t0            REG_ADDR32(0x84)
#define reg_spwm_t1            REG_ADDR32(0x88)
#define reg_spwm_t2            REG_ADDR32(0x8c)
enum{
	FLD_SPWM_HIGH  = 		BIT_RNG(0,10),
	FLD_SPWM_LOW  = 		BIT_RNG(11,21),
	FLD_SPWM_PHASE  = 		BIT_RNG(22,32),
};

#define SPWM_N                 0x90
#define reg_spwm_n0            REG_ADDR16(0x90)
#define reg_spwm_n1            REG_ADDR16(0x92)
#define reg_spwm_n2            REG_ADDR16(0x94)

#define reg_spwm_mask          REG_ADDR8(0x96)
enum{
	FLD_SPWM0_IRQ_EN  = 			BIT(0),
	FLD_SPWM1_IRQ_EN  = 			BIT(1),
	FLD_SPWM2_IRQ_EN =              BIT(2),
};

#define reg_spwm_stat          REG_ADDR8(0x97)
enum{
	FLD_SPWM0_IRQ_FLAG  = 			BIT(0),
	FLD_SPWM1_IRQ_FLAG  = 			BIT(1),
	FLD_SPWM2_IRQ_FLAG =            BIT(2),
};
...
enum{
	...
	FLD_PWM2_FUNC = 			BIT(9),
	FLD_SWS_FUNC = 				BIT(10),
	FLD_UART_RX_FUNC =			BIT(11),
	FLD_UART_TX_FUNC =			BIT(12),
	FLD_SWM_FUNC =				BIT(13),
