...
#define reg_i2c_address      REG_ADDR8(0x01)
/****************************************************
...
#define reg_pwm_ctrl_all        REG_ADDR8(0xac)
...
#define reg_gpio_g0             REG_ADDR32(0x5b0)
#define reg_gpio_g1             REG_ADDR32(0x5b4)
#define reg_gpio_g2             REG_ADDR32(0x5b8)
#define reg_gpio_g3             REG_ADDR32(0x5bc)
...
enum{
	...
	FLD_IRQ_GPIO_RISC0_EN =     BIT(18),
	FLD_IRQ_PM_EN =				BIT(19),
	FLD_IRQ_OCI2_EN =			BIT(20),
	FLD_IRQ_OCI1_EN =			BIT(21),
	FLD_IRQ_OCI0_EN =		    BIT(22),
