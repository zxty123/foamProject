...
#define		V1P75_REF			REF_VOLTAGE_SEL_6
#define		V1P75_SCALE			SCALING_SELECT_HALF
#define		V1P75_AHALF			0
...
#define		VBAT_LOW_SCALE_MIDL	(V1P75_SCALE | V1P75_AHALF)
#define		VBAT_LOW_REF_MIDL	(V1P75_REF)

#define		VBAT_LOW_SCALE_D	(VBAT_LOW_LEVLE==V1P0 ? V2P0_SCALE | V2P0_AHALF : V2P2_SCALE | V2P2_AHALF)
#define		VBAT_LOW_REF_D		(VBAT_LOW_LEVLE==V1P0 ? V2P0_REF : V2P2_REF)
...
static inline	int battery_detection_with_ldo_auto  (u8 chn, int set){
	if( set ){
		return battery_direct_detection ( chn, set );
	}
	else{
		if ( battery_low_by_set (chn, VBAT_LOW_REF_MIDL, VBAT_LOW_SCALE_MIDL) ){
			return battery_low_by_set (chn, VBAT_LOW_REF_S, VBAT_LOW_SCALE_S) ;
		}
		else{
			return battery_low_by_set (chn, VBAT_LOW_REF_D, VBAT_LOW_SCALE_D) ;
		}
	}
}
