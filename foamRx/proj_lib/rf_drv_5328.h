...
#define FR_TX_PA_MAX_POWER	0x44
#define FR_TX_PA_MIN_POWER	0xc4
//#define	RF_TX_PA_POWER_LOW		WriteAnalogReg (0x9e, 0x08)
//#define	RF_TX_PA_POWER_HIGH		WriteAnalogReg (0x9e, 0xff)
//#define	RF_TX_PA_POWER_LEVEL(high)		WriteAnalogReg (0x9e, high ? 0xff : 0x08)
...
#define	RF_TX_PA_POWER_LEVEL(high)		{WriteAnalogReg (0x9e, high ? 0xff : 0x08);}while (0)
